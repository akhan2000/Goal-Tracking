defmodule GoalmaticExAk556Web.ChallengeControllerTest do
  use GoalmaticExAk556Web.ConnCase

  import GoalmaticExAk556.AchievementFixtures

  @create_attrs %{description: "some description", ends_at: ~U[2023-03-26 01:08:00Z], goal: 42, name: "some name", units: "some units"}
