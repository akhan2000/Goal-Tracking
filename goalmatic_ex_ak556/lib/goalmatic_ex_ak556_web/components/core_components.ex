defmodule GoalmaticExAk556Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GoalmaticExAk556Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GoalmaticExAk556Web.Gettext, "errors", msg, opts)
    end
  end
